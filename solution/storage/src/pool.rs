...
pub fn init_pool<T: Into<String>>(database_url: T) -> Result<PgPool, Error> {
...
/// WARNING: Calling this more than once will introduce connection leaks
pub fn pooled_connection() -> Result<PooledConn, Error> {
    let pool = get_pool()?;
...
/// WARNING: Calling this more than once will introduce connection leaks
pub fn get_pool_by_url(url: String) -> Result<PgPool, Error> {
...
/// WARNING: Calling this more than once will introduce connection leaks
pub fn create_pooled_connection_by_url(database_url: String) -> Result<PooledConn, Error> {
